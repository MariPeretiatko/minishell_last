...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/22 22:26:16 by mperetia          #+#    #+#             */
/*   Updated: 2024/04/22 22:26:17 by mperetia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/minishell.h"

static void	file_finder(t_execute *exec, int cmd_nb, int pipe_fd[2][2], int i);
