...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/22 22:30:24 by mperetia          #+#    #+#             */
/*   Updated: 2024/04/22 22:30:24 by mperetia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*parse_operator(char *cmd)
{
	...
	while (new_cmd[i])
	{
		...
		{
			if (i > 1 && ft_strlen(new_cmd) > 1 && !is_space(new_cmd[i - 1])
				&& !is_redirection(new_cmd[i - 1]))
